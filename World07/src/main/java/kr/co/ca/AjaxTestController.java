...
public class AjaxTestController {
	...
	public void at4(@RequestParam Map<String, Object> map) {
		String jsonStr = map.get("listStr")map.toString();
		
		ObjectMapper mapper = new ObjectMapper();
		List<Map<String, Object>> list = mapper.readValue(ObjectMapper, new TypeReference<ArrayList<Map<String, Object>>>() {
